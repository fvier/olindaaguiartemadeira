...
// SIMPLE PIE CHART
//
var colors = ["#4697ce", "#7f56da", "#e06d94", "#f8ac59", "#7dcc93"];
var options = {
  chart: {
    height: 320,
    type: "pie",
...
// SIMPLE DONUT CHART
//
var colors = ["#7f56da", "#4697ce", "#e06d94", "#7dcc93", "#f8ac59"];
var options = {
  chart: {
    height: 320,
    type: "donut",
...
var chart = new ApexCharts(document.querySelector("#monochrome-pie"), options);
chart.render();
...
var chart = new ApexCharts(document.querySelector("#patterned-donut"), options);
chart.render();
...
var options = {
  ...
  fill: {
    ...
    image: {
      src: [
        "/static/images/small/img-1.jpg",
        "/static/images/small/img-2.jpg",
        "/static/images/small/img-3.jpg",
        "/static/images/small/img-5.jpg",
      ],
      width: 25,
      imagedHeight: 25,
    },
