...
//
var colors = ["#4697ce", "#7dcc93", "#f8ac59"];
var options = {
  chart: {
    height: 380,
    type: "line",
...
var chart = new ApexCharts(document.querySelector("#line-area-mixed"), options);
chart.render();

//
// LINE, COLUMN & AREA CHART
//
var colors = ["#7dcc93", "#f8ac59", "#e06d94"];
var options = {
  chart: {
    height: 380,
    type: "line",
...
var chart = new ApexCharts(document.querySelector("#all-mixed"), options);
chart.render();
