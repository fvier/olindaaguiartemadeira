...
// BASIC COLUMN CHART
//
var colors = ["#f8ac59", "#e06d94", "#7dcc93"];
var options = {
  chart: {
    height: 396,
    type: "bar",
...
//
var colors = ["#4697ce", "#f8ac59", "#7dcc93"];
var options = {
  chart: {
    height: 380,
    type: "bar",
...
//
var colors = ["#eef2f7", "#4697ce", "#323a46"];
var options = {
  chart: {
    height: 380,
    type: "bar",
...
var chart = new ApexCharts(document.querySelector("#range-column"), options);
chart.render();
...
// quarter chart
//
var colors = ["#4697ce", "#53389f", "#7f56da", "#ff86c8", "#e06d94", "#23c6c8"];
var optionsQuarter = {
  series: [
    {
      data: [],
